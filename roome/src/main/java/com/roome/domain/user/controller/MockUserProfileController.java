...
public class MockUserProfileController {
    ...
    public ResponseEntity<Map<String, String>> updateMockUserProfile(@AuthenticationPrincipal OAuth2UserPrincipal principal, @RequestBody UpdateProfileRequest request) {
    ...
    public ResponseEntity<ImageUploadResponseDto> uploadMockProfileImage(
        ...
        String mockImageUrl = "https://" + MOCK_BUCKET_NAME + ".s3.ap-northeast-2.amazonaws.com/profile/" + mockUuid + "." + mockFileExtension;
    ...
    private List<RecommendedUserDto> generateMockSimilarUsers() {
        return List.of(
                RecommendedUserDto.builder().userId(1L).nickname("Mock User 1").profileImage("https://github.com/user-attachments/assets/912a4bc2-da94-4551-8547-b8a47c6e6813").build(),
                RecommendedUserDto.builder().userId(2L).nickname("Mock User 2").profileImage("https://github.com/user-attachments/assets/912a4bc2-da94-4551-8547-b8a47c6e6813").build(),
                RecommendedUserDto.builder().userId(3L).nickname("Mock User 3").profileImage("https://github.com/user-attachments/assets/912a4bc2-da94-4551-8547-b8a47c6e6813").build(),
                RecommendedUserDto.builder().userId(4L).nickname("Mock User 4").profileImage("https://github.com/user-attachments/assets/912a4bc2-da94-4551-8547-b8a47c6e6813").build(),
                RecommendedUserDto.builder().userId(5L).nickname("Mock User 5").profileImage("https://github.com/user-attachments/assets/912a4bc2-da94-4551-8547-b8a47c6e6813").build()
        );
    }
