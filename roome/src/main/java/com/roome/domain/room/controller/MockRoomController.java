...
public class MockRoomController {
  ...
  public ResponseEntity<UpdateRoomThemeResponseDto> updateRoomTheme(
    ...
    UpdateRoomThemeResponseDto response = new UpdateRoomThemeResponseDto(roomId,
  ...
  public ResponseEntity<ToggleFurnitureResponseDto> toggleFurnitureVisibility(
    ...
    List<FurnitureResponseDto> furnitureList = List.of(
        new FurnitureResponseDto("BOOKSHELF", true, 3,
            FurnitureCapacity.getCapacity(FurnitureType.BOOKSHELF, 3), getMockTop3BookGenres()),
        new FurnitureResponseDto("CD_RACK", false, 1,
            FurnitureCapacity.getCapacity(FurnitureType.CD_RACK, 1), getMockTop3CdGenres())
    );
