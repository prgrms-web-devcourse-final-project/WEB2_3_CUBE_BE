...
public class MockPaymentController {
    ...
    public ResponseEntity<PaymentResponseDto> mockRequestPayment(
        ...
        log.info("[MOCK] 결제 요청: orderId={}, amount={}", requestDto.getOrderId(), requestDto.getAmount());
    ...
    public ResponseEntity<PaymentResponseDto> mockVerifyPayment(
        ...
        log.info("🛠 [MOCK] 결제 검증 요청: orderId={}, paymentKey={}", verifyDto.getOrderId(), verifyDto.getPaymentKey());
